...
content = re.sub(
    r'function frontend_learning_data_scrape_url_handler\(\) \{.*?wp_send_json_success\(\[\'post_id\' => \$post_id\]\);\n\}',
    new_scrape_handler,
    content,
    flags=re.DOTALL
)
...
# -------------------------------------------------------------------------------------
# 2. Update frontend_learning_data_distill_from_seed_handler
# -------------------------------------------------------------------------------------
...
content = re.sub(
    r'function frontend_learning_data_distill_from_seed_handler\(\) \{.*?wp_send_json_success\(\[\'post_id\' => \$post_id\]\);\n\}',
    new_distill_seed_handler,
    content,
    flags=re.DOTALL
)
...
# -------------------------------------------------------------------------------------
# 3. Update frontend_learning_data_distill_handler (Existing Refinement)
# -------------------------------------------------------------------------------------
...
content = re.sub(
    r'function frontend_learning_data_distill_handler\(\) \{.*?wp_send_json_success\(\[\n\s*\'message\' => sprintf.*?\]\);\n\}',
    new_distill_handler,
    content,
    flags=re.DOTALL
)
